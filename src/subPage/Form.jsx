...
const BookNowForm = () => {
    ...
    const editItem = cartItem[id]
    console.log(editItem )
    const [user, setUser] = useState({
        fname:editItem &&  editItem.fname?editItem.fname:"",
        lname:editItem &&  editItem.lname?editItem.lname:"",
        email:editItem &&  editItem.email?editItem.email:"",
        contact:editItem &&  editItem.contact?editItem.contact:"",
        gender: editItem && editItem.gender?editItem.gender:"",
        destination: editItem && editItem.destination?editItem.destination:"",
        city: editItem && editItem.city?editItem.city:"",
        person: editItem && editItem.person?editItem.person:1,
    });
    ...
    //     editItem = cartItem.filter((s)=>console.log(s.id===id))
    //     // console.log(editItem)
    // }
    // useEffect(()=>{
    //     filterCartItem();
